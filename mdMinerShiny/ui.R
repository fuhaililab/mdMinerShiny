...
body <- dashboardBody(
  tabItems(
    tabItem(tabName = "about",
      ...
      h2(),
      h2("Instructions:"),
      h3("1. Go to Start and upload your foldchange data"),
      h3("2. After the uploading is complete, go to Drug Ranking to see the drug scores"),
      h3("3. Select a drug and see the networks in Network Display"),
